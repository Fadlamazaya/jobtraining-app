...
export default function Environment() {
  ...
  const [data, setData] = useState(() => {
    const saved = localStorage.getItem("kompetensiEnvironment");
    return saved ? JSON.parse(saved) : defaultData;
  });

  // simpan ke localStorage setiap kali data berubah
  useEffect(() => {
    localStorage.setItem("kompetensiEnvironment", JSON.stringify(data));
  }, [data]);
  ...
  return (
    <div className="p-6">
      ...
      <p className="mb-4 font-medium">Unit 3 : Environment Protection Plant</p>
