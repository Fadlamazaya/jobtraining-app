...
export default function Maintenance() {
  ...
  const [data, setData] = useState(() => {
    const saved = localStorage.getItem("kompetensiMaintenance");
    return saved ? JSON.parse(saved) : defaultData;
  });

  // simpan ke localStorage setiap kali data berubah
  useEffect(() => {
    localStorage.setItem("kompetensiMaintenance", JSON.stringify(data));
  }, [data]);
  ...
  return (
    <div className="p-6">
      ...
      <p className="mb-4 font-medium">Unit 5 : Maintenance Plant</p>
