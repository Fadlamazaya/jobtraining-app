...
// --- Komponen Modal Kustom (Sama seperti di EmployeeEnergi) ---
...
// --- Komponen Utama EmployeeWater ---
export default function EmployeeWater() {
    // ⭐️ PENYESUAIAN KEY & JUDUL UNTUK WATER TREATMENT PLANT
    const LOCAL_STORAGE_KEY = "kompetensiWaterTreatmentPlant";
                            ...
                            {data.length === 0 ? (
                                <tr>
                                    <td colSpan="7" className="text-center py-8 text-gray-500 font-medium">
                                        Belum ada data peserta untuk Water Treatment Plant. Silakan tambahkan.
                                    </td>
                                </tr>
                            ) : (
                                data.map((row, index) => (
                                    <React.Fragment key={row.no}> 
                                        {/* Baris data... (Sama seperti EmployeeEnergi) */}
