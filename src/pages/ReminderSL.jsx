...
export default function ReminderSL() {
  ...
  return (
    <div className="p-6">
      <div className="bg-white p-6 rounded-xl shadow-md">
        <h2 className="text-2xl font-bold mb-2 text-gray-800">📅 Reminder</h2>
        <p className="mb-4 font-medium text-gray-600">Posisi : SL/SPV</p>
